$(document).ready(function() {
    ...
    var time = 15;
    // will keep track of right guesses for end game
    var correctGuesses = 0;
    //will keep track of wrong guesses for end game
    ...
    var questions = [
        ...
        {
	    question: "The main character of Uncharted?",
	  ...
	  {
	    question: "What is the name of the archaeologist in the game Tomb Raider?",
	...
	function resultsScreen() {
		if (correctGuesses === questions.length) {
			var endMessage = "Too amazing!";
			var bottomText = "#nerdalert!";
		}
		else if (correctGuesses > incorrectGuesses) {
			var endMessage = "Good luck next time!";
			var bottomText = "See ya next time!";
		}
		else {
	...
	function nextQuestion() {
		if (questionCounter < questions.length) {
			time = 15;
			$("#gameScreen").html("<p>You only have <span id='timer'>" + time + "</span> seconds left!</p>");
			questionContent();
			timer();
			userTimeout();
		}
